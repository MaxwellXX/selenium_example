...
if __name__ == '__main__':
    # xy = color_match_diff_scale('plaza1-canvas.png', '广场3.png', True)
    # template_matcher_multi_img('big.jpg', 'small2.jpg')
    xy = color_match_diff_scale('plaza1-canvas1.png', '广场1.png', True)
    print(xy)
    # ImageMatch.find_image('plaza1-canvas1.png', '广场1.png')
